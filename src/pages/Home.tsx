              ...
              <div className="info-card">
                <div className="flex items-center gap-2 mb-4">
                  <div className="flex -space-x-2">
                    {teamMembers.map((member, index) => <div key={member.name} className="w-10 h-10 rounded-full border-2 border-background bg-muted overflow-hidden" style={{
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col items-center gap-8">
            ...
            <div className="flex flex-wrap justify-center gap-6">
              {['Discord', 'YouTube', 'Twitter', 'TikTok', 'Instagram'].map(social => <a key={social} href="#" className="text-muted-foreground hover:text-primary transition-colors relative group">
                  {social}
